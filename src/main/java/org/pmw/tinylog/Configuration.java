...
public final class Configuration {
	...
	// --- manually added ---
	private final Map<Writer, Level> writerLevels;
	...
	// --- manually added ---
	private static Map<Writer, Level> getWriterLevels(final List<WriterDefinition> definitions){
		Map<Writer, Level> writerLevelMap = new HashMap<Writer, Level>();
